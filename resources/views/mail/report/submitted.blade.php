...
@if ($mail_to == 'owner')
Thank you for submitting your {{ $event->report->is_change ? 'Change Request' : 'Report' }}. It is pending review with our Curators. You will reveive further updates via email.
@else
