<div>
    <div class="feedback">
        <a class="group relative isolate flex items-center rounded-lg px-2 py-0.5 text-[0.8125rem]/6 text-dark/30 transition-colors gap-x-2"
            target="_blank" href="https://github.com/Steinbeck-Lab/coconut/issues"><span
                class="absolute inset-0 -z-10 scale-75 rounded-lg bg-white/5 opacity-0 transition"></span><svg
                viewBox="0 0 16 16" aria-hidden="true" fill="currentColor" class="flex-none h-5 w-5">
                <path
