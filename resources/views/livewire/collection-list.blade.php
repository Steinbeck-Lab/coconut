                ...
                <div class="flex h-16 flex-shrink-0 rounded-md border border-gray-900 border-b-4">
                    <div class="flex flex-1 justify-between md:px-4">
                        ...
                        <div class="flex items-center gap-3 mr-3">
                            <label for="sort" class="text-sm font-medium text-gray-600 whitespace-nowrap hidden sm:block">Sort by:</label>
                            <select id="sort" wire:model.live="sort" 
                                class="rounded-md border border-gray-300 bg-white py-2 pl-3 pr-8 text-sm text-gray-700 focus:border-gray-400 focus:outline-none focus:ring-0">
