    ...
    <div class="w-full max-w-xl">
        <div class="flex items-center justify-between" x-data="{ on: false }">
            <span class="flex flex-grow flex-col">
                <span class="text-sm font-medium leading-6 text-gray-900" id="availability-label">3D Structure <span class="text-sm text-gray-500">(by RDKit)</span></span>
                <span class="text-sm text-gray-500" id="availability-description">Interactive JSMol molecular viewer
                </span>
            </span>
            <!-- Download Button -->
            <span class="relative flex justify-center cursor-pointer mr-4" x-on:click="$wire.downloadMolFile(toolkit)" :title="`Download SDF file from RDKit`" >
