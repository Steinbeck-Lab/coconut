<div class="mx-auto max-w-4xl lg:max-w-7xl px-4 md:px-10">
        ...
        <div class="mx-auto max-w-3xl px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8">
            <div class="flex items-center space-x-5">
                <div>
                    ...
                    <h2 class="mb-2 text-2xl break-all font-bold leading-7 break-words text-gray-900 sm:text-3xl sm:tracking-tight">
                        {{ $molecule->name ? $molecule->name : $molecule->iupac_name }}
                    </h2>
                    <p class="text-sm font-medium text-gray-500">Created on <time datetime="{{ $molecule->created_at }}">{{ $molecule->created_at }}</time> &middot; Last
            ...
            <dl class="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:px-2 xl:px-0">
                <div class="flex items-baseline flex-wrap justify-between gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8 ">
                    <dt class="font-medium text-gray-500"> NPLikeness
                        <div class="tooltip"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="h-5 w-5 -mt-1 inline cursor-pointer">
                    ...
                    <div data-v-5784ed69="" class="inline-block" style="border: 30px solid transparent; margin: -30px; --c81fc0a4: 9999;">
                        ...
                        <div class="flex items-center">
                            @for ($i = 0; $i < $molecule->annotation_level; $i++)
                                <span class="text-amber-300">★<span>
                                        @endfor
                                        @for ($i = $molecule->annotation_level; $i < 5; $i++) ☆ @endfor </div>
                        </div>
                    </div>
                        ...
                        <div>
                            <dt class="font-medium text-gray-500">
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div x-data="{ tooltip: false }" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" class="ml-2 h-5 w-5 cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <div x-show="tooltip" class="text-sm text-white absolute bg-green-400 rounded-lg p-2
 transform -translate-y-8 translate-x-8">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $molecule->properties->exact_molecular_weight }}</dd>
                        </div>
                    </div>
                    <div class="flex items-baseline flex-wrap justify-between gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8 sm:border-l">
                        <div>
        ...
        <div class="mx-auto mt-8 grid max-w-3xl grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
            <div class="space-y-6 lg:col-span-2 lg:col-start-1">
                    ...
                    <div class="bg-white border shadow sm:rounded-lg" x-data="{ showAll: false }">
                        ...
                        <div class="border-t border-gray-200">
                            <div class="no-scrollbar px-4 py-4 lg:px-8 min-w-0">
                                <ul role="list" class="mt-2 leading-8">
                                    ...
                                    <li class="inline" x-show="showAll || {{ $index }} < 10">
                                        <span class="isolate inline-flex rounded-md shadow-sm mb-2">
                                            <a href="/search?type=tags&amp;q={{ urlencode($organism->name) }}&amp;tagType=organisms" target="_blank" class="relative inline-flex items-center rounded-l-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-10 organism">
                                                {{ $organism->name }}&nbsp;
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m9 9 6-6m0 0 6 6m-6-6v12a6 6 0 0 1-12 0v-3" />
                                                </svg>
                                            </a>
                                            <a href="{{ urldecode($organism->iri) }}" target="_blank" class="relative -ml-px inline-flex items-center rounded-r-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-10 capitalize">
                                                {{ $organism->rank }}&nbsp;
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                                ...
                                <div class="mt-4">
                                    <button @click="showAll = true" x-show="!showAll" class="text-base font-semibold leading-7 text-secondary-dark text-sm">
                                        View More ↓
                                    </button>
                                    <button @click="showAll = false" x-show="showAll" class="text-base font-semibold leading-7 text-secondary-dark  text-sm">
                                        View Less ↑
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="">
                                        <section id="representations" class="my-4">
                                            <div class="group/item -ml-4 rounded-xl p-4 hover:bg-slate-100">
                                                <dt class="text-sm font-medium text-gray-500 sm:flex sm:justify-between">
                                                    COCONUT id
                                                </dt>
                ...
                <section aria-labelledby="notes-title">
                    <div class="bg-white shadow border sm:overflow-hidden sm:rounded-lg" x-data="{ showAllSynonyms: false }">
                        <div class="divide-y divide-gray-200">
                            ...
                            <div class="px-4 py-6 sm:px-6">
                                ...
                                <div class="justify-center mt-4 ">
                                    <button @click="showAllSynonyms = true" x-show="!showAllSynonyms" class="text-base font-semibold leading-7 text-secondary-dark text-sm">
                                        View More ↓
                                    </button>
                                    <button @click="showAllSynonyms = false" x-show="showAllSynonyms" class="text-base font-semibold leading-7 text-secondary-dark  text-sm">
                                        View Less ↑
                                    </button>
                                </div>
                                @else
                            ...
                            <div class="px-4 py-6 sm:px-6">
                                <div>
                                    <ul role="list" class="px-0">
                                        ...
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Aromatic Ring Count :
                                                {{ $molecule->properties->aromatic_rings_count }}</span></li>
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Rotatable Bond count :
                                                {{ $molecule->properties->rotatable_bond_count }}</span></li>
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Minimal number of rings
                                                : {{ $molecule->properties->number_of_minimal_rings }}</span></li>
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Formal Charge :
                                                {{ $molecule->properties->total_atom_count }}</span></li>
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Contains Sugar :
                                                {{ $molecule->properties->contains_sugar ? 'True' : 'False' }}</span>
                                        </li>
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Contains Ring Sugars :
                                                {{ $molecule->properties->contains_ring_sugars ? 'True' : 'False' }}</span>
                                        </li>
                                        <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">Contains Linear Sugars
                                                :
                ...
                <section aria-labelledby="notes-title">
                    <div class="bg-white shadow border sm:overflow-hidden sm:rounded-lg">
                        <div class="divide-y divide-gray-200">
                            ...
                            <div class="px-4 py-6 sm:px-6">
                                <ul role="list" class="">
                                    <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500">NP-likeness scores :
                                ...
                                <div class="px-4 py-6 sm:px-6">
                                    ...
                                    <div x-data="{ showAllCitations: false }">
                                        <div class="not-prose grid grid-cols-1 gap-6 sm:grid-cols-2">
                                            ...
                                            @if ($citation->title != '')
                                            <div class="group relative rounded-xl border border-slate-200" x-show="showAllCitations || {{ $index }} < 6">
                                                ...
                                                <div class="relative overflow-hidden rounded-xl p-6">
                                                    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" class="h-8 w-8 [--icon-foreground:theme(colors.slate.900)] [--icon-background:theme(colors.white)]">
                                                        <defs>
                                                            <radialGradient cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" id=":R1k19n6:-gradient" gradientTransform="matrix(0 21 -21 0 12 11)">
                                                            ...
                                                            <radialGradient cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" id=":R1k19n6:-gradient-dark" gradientTransform="matrix(0 24.5 -24.5 0 16 5.5)">
                                                                <stop stop-color="#0EA5E9"></stop>
                                                                <stop stop-color="#22D3EE" offset=".527">
                                                                </stop>
                                                                <stop stop-color="#818CF8" offset="1">
                                                        ...
                                                        <g class="hidden">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3 2a1 1 0 0 0-1 1v21a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H3Zm16.752 3.293a1 1 0 0 0-1.593.244l-1.045 2A1 1 0 0 0 17 8v13a1 1 0 0 0 1.71.705l7.999-8.045a1 1 0 0 0-.002-1.412l-6.955-6.955ZM26 18a1 1 0 0 0-.707.293l-10 10A1 1 0 0 0 16 30h13a1 1 0 0 0 1-1V19a1 1 0 0 0-1-1h-3ZM5 18a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2H5Zm-1-5a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1Zm1-7a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2H5Z" fill="url(#:R1k19n6:-gradient-dark)">
                                                            </path>
                                                        </g>
                                                    </svg>
                                                    <h2 class="mt-2 font-bold text-base text-gray-900">
                                                        <a target="_blank" href="https://doi.org/{{ $citation->doi }}">
                                                            <span class="absolute -inset-px rounded-xl"></span>{{ $citation->title }}
                                                        </a>
                                                    </h2>
                                                    <h2 class="mt-2 font-display text-base text-slate-900">
                                                        <a target="_blank" href="https://doi.org/{{ $citation->doi }}">
                                                            <span class="absolute -inset-px rounded-xl"></span>{{ $citation->authors }}
                                                        </a>
                                                    </h2>
                                                    <h2 class="mt-2 font-display text-base text-slate-900">
                                                        <a target="_blank" href="https://doi.org/{{ $citation->doi }}">
                                                            <span class="absolute -inset-px rounded-xl"></span>{{ $citation->doi }}
                                                        </a>
                                                    </h2>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex justify-center mt-4">
                                            <button @click="showAllCitations = true" x-show="!showAllCitations" class="text-base font-semibold leading-7 text-secondary-dark text-sm">
                                                View More ↓
                                            </button>
                                            <button @click="showAllCitations = false" x-show="showAllCitations" class="text-base font-semibold leading-7 text-secondary-dark text-sm">
                                                View Less ↑
                                            </button>
                                        </div>
                                        @endif
                                    ...
                                    <div class="not-prose grid grid-cols-1 gap-6 sm:grid-cols-1" x-data="{ showAllCollections: false }">
                                        @foreach ($molecule->collections as $index => $collection)
                                        <a href="/search?type=tags&amp;q={{ $collection->title }}&amp;tagType=dataSource" x-show="showAllCollections || {{ $index }} < 6">
                                            <div class="group relative rounded-xl border border-slate-200">
                                                ...
                                                <div class="relative overflow-hidden rounded-xl p-6">
                                                    <svg aria-hidden="true" viewBox="0 0 32 32" fill="none" class="h-8 w-8 [--icon-foreground:theme(colors.slate.900)] [--icon-background:theme(colors.white)]">
                                                        ...
                                                        <g class="hidden">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3 2a1 1 0 0 0-1 1v21a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H3Zm16.752 3.293a1 1 0 0 0-1.593.244l-1.045 2A1 1 0 0 0 17 8v13a1 1 0 0 0 1.71.705l7.999-8.045a1 1 0 0 0-.002-1.412l-6.955-6.955ZM26 18a1 1 0 0 0-.707.293l-10 10A1 1 0 0 0 16 30h13a1 1 0 0 0 1-1V19a1 1 0 0 0-1-1h-3ZM5 18a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2H5Zm-1-5a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1Zm1-7a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2H5Z" fill="url(#:R1k19n6:-gradient-dark)"></path>
                                                        </g>
                                                    </svg>
                                                    <h2 class="mt-2 font-bold text-base text-gray-900">
                                                        <span class="absolute -inset-px rounded-xl"></span>{{ $collection->title }}
                                                    </h2>
                                                    <h2 class="mt-2 font-display text-base text-slate-900">
                                                        <span class="absolute -inset-px rounded-xl"></span>{{ $collection->description }}
                                                    </h2>
                                                    <h2 class="mt-2 font-display text-base text-slate-900">
                                                        <span class="absolute -inset-px rounded-xl"></span>{{ $collection->doi }}
                                                    </h2>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <div class="flex justify-center mt-4">
                                            <button @click="showAllCollections = true" x-show="!showAllCollections" class="text-base font-semibold leading-7 text-secondary-dark text-sm">
                                                View More ↓
                                            </button>
                                            <button @click="showAllCollections = false" x-show="showAllCollections" class="text-base font-semibold leading-7 text-secondary-dark text-sm">
                                                View Less ↑
                                            </button>
                                        </div>
                                        @endif
                        ...
                        <div class="divide-y divide-gray-200">
                            ...
                            <div class="px-4 py-6 sm:px-6">
                                <ul role="list" class="px-0">
                                    ...
                                    <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500"><b>Class</b>:
                                            {{ $molecule->properties && $molecule->properties['chemical_class'] ? $molecule->properties['chemical_class'] : '-' }}</span>
                                    </li>
                                    <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500"><b>Sub
                                                class</b>:
                                            {{ $molecule->properties && $molecule->properties['chemical_sub_class'] ? $molecule->properties['chemical_sub_class'] : '-' }}
                                        </span>
                                    </li>
                                    <li class="py-5 flex md:py-0"><span class="ml-3 text-base text-gray-500"><b>Direct
                                                parent</b>:
            ...
            <section aria-labelledby="timeline-title" class="lg:col-span-1 lg:col-start-3">
                                ...
                                <div class="relative pb-8">
                                    <div class="relative flex space-x-3">
                                        <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                            <div>
                                                <p class="text-sm text-gray-500">Created at <a href="#" class="font-medium text-gray-900"></a></p>
                                                <time datetime="{{ $molecule->created_at }}">{{ $molecule->created_at }}</time>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <dl class="mt-5 flex w-full">
                    <div class="text-center md:text-left">
                        <dd class="mt-1"><a class="text-base font-semibold text-text-dark hover:text-slate-600" href="http://localhost/dashboard/reports/create?compound_id={{ $molecule->identifier }}">
                                Report this compound <span aria-hidden="true">→</span></a></dd>
                        <dd class="mt-1"><a class="text-base font-semibold text-text-dark hover:text-slate-600" href="https://dev.coconut.naturalproducts.net/compounds/{{ $molecule->identifier }}/update">Request
