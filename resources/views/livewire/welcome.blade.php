   ...
   s23.273,10.438,23.273,23.273S187.385,325.818,174.55,325.818z" />
    ...
    <div class="mx-auto bg-gray-900">
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 class="text-balance text-3xl font-semibold tracking-tight text-white sm:text-4xl">Interested in incorporating COCONUT into your workflow or developing custom solutions around our data?</h2>
            <p class="mt-6 text-pretty text-lg/8 text-gray-300">All the information you need is comprehensively documented and ready for you to explore!</p>
