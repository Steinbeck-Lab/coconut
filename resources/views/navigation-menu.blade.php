                            ...
                            @else
                                 <span class="inline-flex rounded-md">
                                    <button type="button"
                                        ...
                                        <img class="fi-avatar object-cover object-center fi-circular rounded-full h-8 w-8 fi-user-avatar" src="{{ config('services.avatars.url') }}?name={{
