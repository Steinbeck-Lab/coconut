                ...
                Section::make()
                    ...
                    ->schema([
                        ImageEntry::make('parent_canonical_smiles')->state(function ($record) {
                            return env('API_URL', 'https://api.cheminf.studio/latest/').'depict/2D?smiles='.urlencode($record->parent_canonical_smiles).'&height=300&width=300&CIP=true&toolkit=cdk';
                        })
                            ->width(200)
                            ->height(200)
                            ->ring(5)
                        ...
                        ImageEntry::make('standardized_canonical_smiles')->state(function ($record) {
                            return env('API_URL', 'https://api.cheminf.studio/latest/').'depict/2D?smiles='.urlencode($record->standardized_canonical_smiles).'&height=300&width=300&CIP=true&toolkit=cdk';
                        })
                            ->width(200)
                            ->height(200)
                            ->ring(5)
