    ...
    public function render()
    {
        return view('livewire.molecule-details')
            ->layoutData([
                ...
                'inchi' => $this->molecule->standard_inchi,
                'inchiKey' => $this->molecule->standard_inchi_key,
                'iupacName' => $this->molecule->iupac_name,
                'molecularFormula ' => $this->molecule->molecular_formula,
                'molecularWeight ' => $this->molecule->molecular_weight,
                'smiles' => $this->molecule->canonical_smiles,
